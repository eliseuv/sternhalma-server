...
The game logic is implemented in the `sternhalma-game` crate, and the Python bindings are implemented in the `sternhalma-python` crate.
...
- `sternhalma-web`: The React/TypeScript web client.
